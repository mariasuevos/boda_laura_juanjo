            ...
            <div className="container mx-auto px-4">
                ...
                <div className="max-w-md mx-auto bg-white rounded-xl shadow-xl overflow-hidden mb-12">
                    <div className="p-8 flex flex-col items-center text-center">
                        ...
                        <h3 className="text-2xl font-serif text-stone-800 mb-2">Localización</h3>
                        <p className="text-xl text-stone-600 font-serif mb-4">El Parador de Albacete</p>

                        <div className="flex items-center text-stone-500 mb-8">
                            <Clock className="w-4 h-4 mr-2" />
                            <span className="text-sm uppercase tracking-widest">De 17:00h a 01:00h</span>
                        </div>
